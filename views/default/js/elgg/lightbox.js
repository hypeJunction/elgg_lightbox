/**
 * Lightbox module
 * Enhances the built-in elgg/lightbox with colorbox support.
 *
...
const lightbox = {
	...
	getOptions: function (opts) {
		...
		var settings = {
			current: echo('js:lightbox:current', ['{current}', '{total}']),
			previous: '<span class="fa fa-caret-left"></span>',
			next: '<span class="fa fa-caret-right"></span>',
			close: '<span class="fa fa-times"></span>',
			xhrError: echo('error:default'),
			imgError: echo('error:default'),
			opacity: 0.5,
			maxWidth: '100%',
		...
		return trigger('getOptions', 'ui.lightbox', null, settings);
	},
	/**
